<template>
    <div class="row">
        ...
        <h3>Hello! looks like you're new here.</h3>
            <p>
                To play ICOSim you need the Nebulas <a target="_blank" class="highlight underline" href="https://chrome.google.com/webstore/detail/nasextwallet/gehjkhmhclgnkkhpfamakecfgakkfkco">Chrome Web Store</a> <a target="_blank" class="highlight underline" href="https://github.com/nebulasio/WebExtensionWallet">(Github)</a> and some <a target="_blank" class="highlight underline" href="http://givemenas.com/home.html">NAS</a>.<br>
